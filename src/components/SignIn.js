          ...
          <div className="w-full max-w-144">
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
              ...
              <div className="mb-6">
                ...
                <input
                  onChange={this.onChange} name="password" autoComplete="on"
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="inline-block align-baseline font-bold text-sm" onClick={this.props.forgotPassword()}>
                  Forgot Password? (not implemented yet)
                </span>
                <button onClick={() => this.props.toggleFormState('signUp')} className="bg-secondary hover:bg-black text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                  Sign Up
                </button>
              </div>
            </form>
