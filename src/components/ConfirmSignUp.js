          ...
          <div className="w-full max-w-144">
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
              ...
              <div className="flex items-center justify-between">
                <button onClick={() => this.props.confirmSignUp(this.state)} className="bg-secondary hover:bg-primary text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                  Confirm Sign Up
                </button>
              </div>
            </form>
