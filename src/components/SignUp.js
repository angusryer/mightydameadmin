          ...
          <div className="w-full max-w-144">
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
              ...
              <div className="mb-6">
                ...
                <input
                  onChange={this.onChange} name="email" autoComplete="on"
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="inline-block align-baseline font-bold text-sm" onClick={() => this.props.toggleFormState('signIn')}>
                  Already signed up?
                </span>
              </div>
            </form>
